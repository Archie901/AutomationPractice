...
def perform_scan():
    ...
    random_qrId = Functions.randomizer(Scans.prod_qrIds)
    print(random_qrId)
    ...
    resp_scan = requests.post(url=Requests.prod_api_domain+Requests.path_scan+random_qrId, data=payload_json, headers=Requests.headers)
