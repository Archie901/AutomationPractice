...
time.sleep(3)
driver.save_screenshot(f'{at.Paths.screenpath_claimProvider1}/8_created_provider_profile.png')
driver.save_screenshot(f'{at.Paths.screenpath_claimProvider2}/8_created_provider_profile.png')
...
insurance_tab.click()
time.sleep(3)
driver.save_screenshot(f'{at.Paths.screenpath_claimProvider1}/9_created_insurances.png')
driver.save_screenshot(f'{at.Paths.screenpath_claimProvider2}/9_created_insurances.png')
locations_tab.click()
time.sleep(5)
driver.save_screenshot(f'{at.Paths.screenpath_claimProvider1}/10_created_locations.png')
driver.save_screenshot(f'{at.Paths.screenpath_claimProvider2}/10_created_locations.png')
# print browser console messages (not working for Firefox)
for entry in driver.get_log('browser'):
    print(entry)
driver.quit()